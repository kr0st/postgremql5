...
__int64 Postgres_DB_Wrapper::begin_transaction()
{
    Mutex::Scoped_Lock lock(mutex_);
...
std::string Postgres_DB_Wrapper::commit(const __int64 trans_ptr)
{
    Mutex::Scoped_Lock lock(mutex_);
...
std::string Postgres_DB_Wrapper::rollback(const __int64 trans_ptr)
{
    Mutex::Scoped_Lock lock(mutex_);
...
std::string Postgres_DB_Wrapper::exec(const __int64 trans_ptr, const std::string& query)
{
    Mutex::Scoped_Lock lock(mutex_);
