...
POSTGREMQL5_API const wchar_t* pmql_connect(const wchar_t* whost, const wchar_t* wport, const wchar_t* wuser, const wchar_t* wpass, const wchar_t* wdb)
{
